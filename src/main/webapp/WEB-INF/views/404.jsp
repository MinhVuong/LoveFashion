...
<script type="text/javascript" src="/resources/js/cartpro/js.js"></script>
							...
							<div class="">
								<div class="col-md-12">
										...
										<div class="global-site-notice noscript">
											<div class="notice-inner">
												<p>
													...
													browser to utilize the functionality of this website.
												</p>
											</div>
										</div>
									</noscript>
									<div class="global-site-notice demo-notice">
										<div class="notice-inner">
											<p>This is a demo store. Any orders placed through this
												store will not be honored or fulfilled.</p>
										</div>
									</div>
								</div>
										...
										<div class="wrapper_404page">
											<div class="col-lg-7 col-md-7">
												<div class="content-404page">
													<p class="top-text">Don't worry you will be back on
														track in no time!</p>
													<p class="img-404">
														<img
															src="/resources/images/404-img-text.png"
															alt="" />
													</p>
													<p class="bottom-text">Page doesn't exist or some other
														error occured. Go to our home page or go back previous
														page</p>
													<div class="button-404">
														<a href="javascript:void(0);" onclick="goBack()"
															class="btn-404 prev-page-btn" title="PREVIOUS PAGE">PREVIOUS
															PAGE</a> <a
															href="#"
															class="btn-404 back2home" title="BACK TO HOMEPAGE">BACK
															TO HOMEPAGE</a>
													</div>
												</div>
											</div>
											...
											<div class="col-lg-5 col-md-5">
												<div class="img-right-404">
													<img
														src="/resources/images/404-image.png"
														alt="" />
												</div>
											</div>
