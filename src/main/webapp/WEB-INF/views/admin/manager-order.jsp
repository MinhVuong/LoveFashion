...
<title>List Orders | Data Tables</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header"> <!-- Logo --> <a href="index.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini"><b>A</b>LT</span> <!-- logo for regular state and mobile devices -->
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview"><a href="#"> <i class="fa fa-laptop"></i> <span>Report</span> <i class="fa fa-angle-left pull-right"></i>
      </a>
        <ul class="treeview-menu">
                ...
                <tbody>
                  <c:forEach var="item" items="${list_orders}">
                    <tr>
                      ...
                      <td>${item.total}</td>
                      <td>
                        <form action="/admin/manager/orders/edit/${item.id}" method="post">
                          <div class="form-group">
                            <select name="status" id="status" class="form-control">
                                <option <c:if test="${item.status == 'pendding'}">selected</c:if> value="pendding">Pendding</option>
                                <option <c:if test="${item.status == 'invoice'}">selected</c:if> value="invoice">Invoice</option>
                                <option <c:if test="${item.status == 'shipping'}">selected</c:if> value="shipping">Shipping</option>
                                <option <c:if test="${item.status == 'cancle'}">selected</c:if> value="cancle">Cancle</option>
                                <option <c:if test="${item.status == 'close'}">selected</c:if> value="close">Close</option>
                            </select>
                          </div>
                      </td>
                      <td>
